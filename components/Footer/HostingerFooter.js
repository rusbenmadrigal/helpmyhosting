...
class HostingerFoooter extends Component {
  render() {
    return (
      <div className="project-details-info">
        ...
        <div className="single-info-box">
          <a href="/out/hostinger/" target="_blank" className="btn btn-warning">
            Visitar Hostinger
          </a>
        </div>
      </div>
...
export default HostingerFoooter;
