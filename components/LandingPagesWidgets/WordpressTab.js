...
class WordpressTab extends Component {
          ...
          <div className="container">
            <div className="content">
              <p>
                ...
                debido al hosting ilimitado que ofrece BanaHosting, además de la
                oportunidad de pagar con dólares y no solo con euros tal como
                sucede con Raiola Networks y por último, BanaHosting ofrece
                servidores en USA y Europa, mientras que Raiola únicamente
                ofrece IP española.
              </p>
              <p>
                No me malentiendas, Raiola Networks es un hosting genial, pero
                principalmente para proyectos que estén enfocados en el mercado
                europeo, si tú vives en España o bien si el proyecto en el que
                trabajas tiene como target usuarios en Europa, Raiola Networks
                es una opción potente, si estás en LATAM BanaHosting es un
            ...
            <div className="tab_content">
              ...
              <div id="tab3" className="tabs_item">
                <div className="row align-items-center">
                  ...
                  <div className="container">
                    <div className="content">
                      <h2>Banahosting Semi Dedicado</h2>
                      <p>
