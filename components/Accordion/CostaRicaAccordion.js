...
class CostaRicaAccordion extends Component {
  render() {
    return (
      <section className="faq-section ptb-100">
        <div className="container">
          <div className="faq-area-content">
            <span>Faqs</span>
            <h3>El mejor hosting Costa Rica</h3>
          </div>
                ...
                <Accordion allowZeroExpanded preExpanded={["a"]}>
                  <AccordionItem uuid="a">
                    ...
                    <AccordionItemPanel>
                      <p>
                        Antes de elegir un{" "}
                        <strong>servicio de hosting en Costa Rica</strong> es
                        importante que usted analice los años que tiene dicho
                        hosting operando en su región, los servicios de hosting
                        web que mencionamos en esta página para Costa Rica son
                        empresas que tienen al menos 7 años en el mercado,
                        además ofrecen estabilizad de servicio de hosting en
                        Costa Rica.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem uuid="c">
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        de hosting en Costa Rica usted se asegure que dicho
                        hosting ofrezca servicio al cliente en todo momento, a
                        toda hora. Por nuestra propia experiencia, el servicio
                        de hosting internacional que ofrece{" "}
...
export default CostaRicaAccordion;
